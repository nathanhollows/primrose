<template>
  <ul class="divide-y divide-base-300">
    <li v-for="contact in contacts" :key="contact.id" class="list-contact rounded-md">
      <RouterLink
        :to="`/contacts/${contact.id}`"
        class="flex items-center p-3 hover:bg-base-300 rounded-md"
      >
        <AvatarCircle
        ...
        />
        <span class="flex-1 text-base dark:text-gray-200"
